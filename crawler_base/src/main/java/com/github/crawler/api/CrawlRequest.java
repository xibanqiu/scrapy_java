...
public final class CrawlRequest implements Serializable {
     ...
     * @return the crawl request with the default configuration
     */
    public static CrawlRequest createDefaultWithAttr(final String requestUrl, CrawlCandidate crawlCandidate) {
        CrawlRequestBuilder builder = new CrawlRequestBuilder(requestUrl);
        builder.setExtInfo(crawlCandidate.getExtInfo());
    ...
    public static final class CrawlRequestBuilder {
         ...
         */
        @Deprecated
        public CrawlRequestBuilder setExtInfo(final Map<String, Object> extInfo) {
            this.extInfo = (JSONObject) JSONObject.toJSON(Validate.notNull(extInfo, "The extInfo parameter cannot be null."));
            return this;
        }
         ...
         * @return the <code>CrawlRequestBuilder</code> instance
         */
        public CrawlRequestBuilder setExtInfo(final JSONObject extInfo) {
            this.extInfo = Validate.notNull(extInfo, "The extInfo parameter cannot be null.");
            return this;
        }
