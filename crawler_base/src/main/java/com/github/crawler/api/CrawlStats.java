...
import com.github.crawler.internal.stats.DurationSerializer;
import com.github.crawler.internal.stats.StatsCounterSnapshot;
...
public final class CrawlStats {
    ...
    public int getParseErrorCount() {
        return statsCounterSnapshot.getParseErrorCount();
    }
    ...
    public int getParseItemCount() {
        return statsCounterSnapshot.getParseItemCount();
    }
    ...
    public int getFilteredDuplicateItemCount() {
        return statsCounterSnapshot.getFilteredDuplicateItemCount();
    }


    public int getParserRelationItemCount() {
        return statsCounterSnapshot.getParserRelationItemCount();
    }
    /**
    ...
    public int getFilteredItemCount(){
        return statsCounterSnapshot.getFilteredItemCount();
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
                ...
                .append("parseItemCount", getParseItemCount())
                .append("parseErrorCount", getParseErrorCount())
                .append("filteredDuplicateRequestCount", getFilteredDuplicateRequestCount())
                .append("filteredDuplicateItemCount", getFilteredDuplicateItemCount())
                .append("parserRelationItemCount", getParserRelationItemCount())
                .append("filteredItemCount", getFilteredItemCount())
